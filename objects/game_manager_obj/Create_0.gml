...
enemy_pool[1,4] = boss_snake_obj;      enemy_parts[1,4] = enemy_snake_particle_spr //
...
enemy_pool[2,2] = enemy_monster_obj;   enemy_parts[2,2] = enemy_sea_particle_spr
enemy_pool[2,3] = enemy_lava_blob_obj; enemy_parts[2,3] = enemy_snake_particle_spr
enemy_pool[2,4] = boss_snake_obj;      enemy_parts[2,4] = enemy_snake_particle_spr //